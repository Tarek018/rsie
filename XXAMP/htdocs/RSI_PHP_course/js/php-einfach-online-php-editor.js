		...
		if(allowExecution) {
			jQuery("#code_editor_"+id).after(
				'<div class="resultbox">'+
					...
					'		<ul class="code-nav">'+
					'			<li><a href="#" id="compileButton" onclick="OnlinePHPEditor.submitCode(\''+id+'\'); return false;" title="'+lang['execute_code']+'"><i id="code_gear-sym_'+id+'" class="fa fa-cog"></i> '+lang['execute']+' <span class="hide-before-execution"></span></a></li>'+
